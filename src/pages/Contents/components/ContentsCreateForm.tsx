...
const ContentsCreateForm: FC<Props> = ({ needCreateForm, editTarget, refetch }) => {
	/**
	 * States
	 */
	...
	const onSubmit: SubmitHandler<IFormValues> = async (data) => {
		...
		if (!editTarget && isEmpty(thumbnail)) {
			errorToast('Please add to main image.');
			return;
		}
	...
	return (
		<>
			<Blank size={20} />
			<Title title="Add/Edit Contents" desc="You can add or edit contents.">
...
export default ContentsCreateForm;
